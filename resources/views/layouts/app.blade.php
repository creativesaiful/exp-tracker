...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <script>
        ...
        $.ajax({
                url: 'currency-converter/' + current_rate,
                type: 'GET',
                data: {
                    code: current_code
                },
                success: function(response) {
                    ...
                    $(".amount").each(function() {
                        ...
                        $(this).text(Math.round(parseInt(currentValue) * current_rate));
                    });
                }
        ...
        $.get('https://openexchangerates.org/api/latest.json', {
            app_id: '241adaf13f2e4d2d9e901e82d1548a10'
        }, function(data) {
            ...
            Object.keys(rates).forEach(function(currencyCode) {
                ...
                if (currencyCode == current_code) {
                   var  selected = 'selected';
                }else{
                    var selected = '';
                }

                options += `<option value="${currencyRate}"   ${selected}  >${currencyCode}</option>`;
            });
        ...
        $('#currency').change(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                     ...
                     sessionStorage.setItem("current_code", response.code);
                     sessionStorage.setItem("current_rate", response.rate);
                    ...
                    $(".amount").each(function() {
                        ...
                        // Convert the text to a number, multiply it by 80, and set it back as the text
                        $(this).text(Math.round(parseInt(currentValue) * rate));
                    });
                }
